...
CREATE TABLE `daily_collection` (
  ...
  `net_collection` decimal(10,2) GENERATED ALWAYS AS ((`total_recharges` - `total_spent`)) STORED,
  PRIMARY KEY (`collection_id`),
  UNIQUE KEY `collection_date` (`collection_date`),
  CONSTRAINT `daily_collection_chk_1` CHECK ((`total_recharges` >= 0)),
  CONSTRAINT `daily_collection_chk_2` CHECK ((`total_spent` >= 0))
