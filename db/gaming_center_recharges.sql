...
CREATE TABLE `recharges` (
  ...
  CONSTRAINT `recharges_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `members` (`member_id`) ON DELETE CASCADE,
...
INSERT INTO `recharges` VALUES (1,1,50.00,'2023-09-10 00:00:00'),(2,2,30.00,'2023-09-12 00:00:00'),(3,3,25.00,'2023-09-15 00:00:00');
